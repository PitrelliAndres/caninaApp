...
// Página de inicio de sesión, ahora con más información y un diseño más acogedor.
export default function LoginPage() {
  const router = useRouter()
  const { login } = useAuth()

  const handleLogin = () => {
    // El hook de autenticación se encarga de la lógica.
    const user = login()
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-6">
      ...
      <div className="text-center max-w-lg w-full">
        ...
        <div className="mt-8">
          <Button onClick={handleLogin} size="lg" className="text-lg px-8 py-6 w-full sm:w-auto">
